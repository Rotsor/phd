...
\newcommand{\FUNCTION}    {\mathbf{function} \SPACE}
\newcommand{\PROCEDURE}   {\mathbf{procedure}\SPACE}
\newcommand{\INPUT}       {\mathbf{input:}   \SPACE}
\newcommand{\OUTPUT}      {\mathbf{output:}  \SPACE}
\newcommand{\RETURN}      {\mathbf{return}   \SPACE}
\newcommand{\STOP}        {\mathbf{stop}}
\newcommand{\assign}      {\leftarrow}
\newcommand{\BEGIN}       {\mathbf{begin}    \SPACE}
\newcommand{\FOR}         {\mathbf{for}      \SPACE}
\newcommand{\TO}          {\SPACE\mathbf{to}\SPACE}
\newcommand{\FORALL}      {\mathbf{for~all}  \SPACE}
\newcommand{\SUCHTHAT}    {\SPACE\mathbf{such~that}\SPACE}
\newcommand{\DO}          {\SPACE\mathbf{do}\SPACE}
\newcommand{\DOPARALLEL}  {\SPACE\mathbf{do~parallel}\SPACE}
\newcommand{\ENDFOR}      {\mathbf{end~for}  \SPACE}
\newcommand{\LOOPFOREVER} {\mathbf{loop~forever}  \SPACE}
\newcommand{\BREAK}       {\mathbf{break}  \SPACE}
\newcommand{\BEGINCRITICALSECTION}  {\mathbf{begin~critical~section}  \SPACE}
\newcommand{\ENDCRITICALSECTION}    {\mathbf{end~critical~section}  \SPACE}
\newcommand{\CHOOSE}      {\mathbf{choose}   \SPACE}
\newcommand{\ACCEPT}      {\mathbf{accept}   \SPACE}
\newcommand{\WHILE}       {\mathbf{while}    \SPACE}
\newcommand{\ENDWHILE}    {\mathbf{end~while}\SPACE}
\newcommand{\iF}          {\mathbf{if}       \SPACE}
\newcommand{\THEN}        {\mathbf{then}\SPACE}
\newcommand{\ELSE}        {\mathbf{else}\SPACE}
\newcommand{\ENDIF}       {\mathbf{end~if}   \SPACE}
