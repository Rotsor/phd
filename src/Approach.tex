...
In this Chapter we have presented an overview of our contribution to handshake circuit resynthesis toolchain and STG composition. We have also discussed our extension of the CPOG formalism and its algebraic underpinnings. This new formalism, called Parametrised Graphs, has been specified and proven in Agda. Finally, we have summarised an application of PGs to the design and encoding of microcontroller instruction set.   
