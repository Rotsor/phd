...
To make notation cleaner we are going to use the following operator precedence rules:
...
\section{Algebraic structure of Parametrised Graphs\label{sec:Algebra-of-parametrised}}
...
\includegraphics[scale=0.73]{fig/packet}
\par\end{centering}

}\hfill{}\subfloat[Matrix phase encoder]{\includegraphics[scale=0.55]{fig/matrix_phase_encoder}
...
\DeclareUnicodeCharacter{8702}{\seqqq} % ⇾
...
%format ⇾ = "\D{\seqqq}"
%format _⇾_ = "\_" ⇾ "\_"
%format ⇾-assoc ="\D{\seqqq{}assoc}"
%format +-assoc ="\D{+assoc}"
%format +-comm = "\D{+comm}"
%format ⇾-identityˡ = "\D{\seqqq{}identity^l}"
%format ⇾-identityʳ = "\D{\seqqq{}identity^r}"
...
%format conditional-⇾ = "\D{conditional\!\seqqq}"
...
%format ⇾-correct = "\D{\seqqq{}correct}"
%format ⇾ʳ-correct = "\D{\seqqq_rcorrect}"
%format ⇾₁-correct = "\D{\seqqq_1correct}"
