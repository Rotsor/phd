...
\begin{tabular}{cc}
\mbox{
\includegraphics[scale=0.6]{figures/Control/sequence-HC}
\vspace{33mm}
}
&
...
\includegraphics[scale=0.6]{figures/Data/binaryfunc-HC}~~\includegraphics[scale=0.25]{figures/Data/binaryfunc}
\par\end{centering}

}

\subfloat[CallMux\label{fig:CallMux}]{\begin{centering}
\includegraphics[scale=0.6]{figures/Data/callmux-HC}~~\includegraphics[scale=0.25]{figures/Data/callmux}
\par\end{centering}

}

\subfloat[Variable\label{fig:Variable}]{\begin{centering}
\includegraphics[scale=0.6]{figures/Data/variable-HC}~~\includegraphics[scale=0.25]{figures/Data/variable}
\par\end{centering}
...
\includegraphics[bb=0bp 0bp 134bp 80bp,scale=0.6]{figures/while-HC}~~\includegraphics[scale=0.25]{figures/while}
\par\end{centering}
...
\includegraphics[scale=0.6]{figures/case-HC}~~\includegraphics[scale=0.25]{figures/case}
\par\end{centering}
