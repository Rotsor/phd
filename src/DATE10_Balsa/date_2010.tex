...
\begin{figure}
\begin{centering}
\includegraphics[width=0.25\paperwidth]{figures/balsa-design-workflow}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.25\paperwidth]{figures/balsa-workflow-modification}
\par\end{centering}
...
\begin{figure}
\subfloat[SequenceOptimised\label{fig:SequenceOptimised}]{

\begin{centering}
\includegraphics[scale=0.5]{figures/Control/sequence-HC}~~\includegraphics[scale=0.15]{figures/Control/sequenceoptimised}
\par\end{centering}
...
\begin{centering}
\includegraphics[scale=0.5]{figures/Control/concur-HC}~~\includegraphics[scale=0.15]{figures/Control/concur}
\par\end{centering}
...
\includegraphics[scale=0.4]{figures/Data/binaryfunc-HC}~~\includegraphics[scale=0.11]{figures/Data/binaryfunc}
\par\end{centering}

}

\subfloat[CallMux\label{fig:CallMux}]{\begin{centering}
\includegraphics[scale=0.5]{figures/Data/callmux-HC}~~\includegraphics[scale=0.13]{figures/Data/callmux}
\par\end{centering}

}

\subfloat[Variable\label{fig:Variable}]{\begin{centering}
\includegraphics[scale=0.5]{figures/Data/variable-HC}~~\includegraphics[scale=0.13]{figures/Data/variable}
\par\end{centering}
...
\includegraphics[bb=0bp 0bp 134bp 80bp,scale=0.5]{figures/while-HC}~~\includegraphics[scale=0.12]{figures/while}
\par\end{centering}
...
\includegraphics[scale=0.5]{figures/case-HC}~~\includegraphics[scale=0.13]{figures/case}
\par\end{centering}
